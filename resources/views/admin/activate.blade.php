...
<div class="container">
    ...
    <div class="row justify-content-md-center border p-4 bg-white">
        <div class="col-6 ml-3">
            <form method="post" action="/administrator/doActivate/{{$user->id}}">
                @csrf
                @method('patch')
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        ...
                        <select name="role" class="custom-select">
                            ...
                            @else
                            <option selected value="{{$user->roles}}">{{$user->roles->title}}</option>
                            @endif
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        ...
                        <select name="organization" class="custom-select">
                            ...
                            @else
                            <option selected value="{{$user->organization}}">{{$user->organizations->title}}</option>
                            @endif
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        ...
                        <select name="designation" class="custom-select">
                            ...
                            @else
                            <option selected value="{{$user->designation}}">{{$user->designation->title}}</option>
                            @endif
