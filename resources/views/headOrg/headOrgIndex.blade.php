...
@section('cont')
<h3 class="p-3 display-4" style="display:inline">Head of Organization</h3>
...
<div class="flex row border-secondary rounded-lg ml-3 justify-content-between">
    ...
    <span>
        <a href="/headOrg/create" class="btn btn-info mr-4" role="button">Create User</a>
    </span>
    ...
    <table class="table table-dark table-striped border-secondary rounded-lg mr-4">
        ...
        <tbody>
            ...
            <tr>
                ...
                @break;
                @endswitch
                <td class="text-center"><a href="/headOrg/show/{{$user->id}}" class="btn btn-outline-info" role="button">...</a></td>
                <td><a href="/headOrg/edit/{{$user->id}}" class="btn btn-outline-warning" role="button">Edit</a></td>
            </tr>
            @endforeach
        </tbody>
    </table>
